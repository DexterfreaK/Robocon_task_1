...
(cl:defmethod cl:initialize-instance :after ((m <lidar-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robo-srv:<lidar-request> is deprecated: use robo-srv:lidar-request instead.")))

(cl:ensure-generic-function 'centerX-val :lambda-list '(m))
(cl:defmethod centerX-val ((m <lidar-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robo-srv:centerX-val is deprecated.  Use robo-srv:centerX instead.")
  (centerX m))

(cl:ensure-generic-function 'centerY-val :lambda-list '(m))
(cl:defmethod centerY-val ((m <lidar-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robo-srv:centerY-val is deprecated.  Use robo-srv:centerY instead.")
  (centerY m))
...
(cl:defmethod cl:initialize-instance :after ((m <lidar-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robo-srv:<lidar-response> is deprecated: use robo-srv:lidar-response instead.")))

(cl:ensure-generic-function 'lidar_array-val :lambda-list '(m))
(cl:defmethod lidar_array-val ((m <lidar-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robo-srv:lidar_array-val is deprecated.  Use robo-srv:lidar_array instead.")
  (lidar_array m))
